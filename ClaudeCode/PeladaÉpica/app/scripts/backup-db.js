// Backup do banco: grava data/backups/copamanager-<data>.db e mantem os 14 mais
...
const destino = join(DIR_BACKUPS, `copamanager-${carimbo}.db`);
...
const antigos = readdirSync(DIR_BACKUPS)
  .filter((a) => a.startsWith('copamanager-') && a.endsWith('.db'))
  .sort();
